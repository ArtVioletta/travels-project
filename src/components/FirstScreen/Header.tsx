  ...
  return (
    <div className="header">
      ...
      <nav className={"navigation"}>
        ...
        <HashLink to="#directions"  className={"nav-element"} onClick={() => setSelectedHasLink('directions')}>Directions</HashLink>
        <HashLink to="#about"  className={"nav-element"} onClick={() => setSelectedHasLink('about')}>About</HashLink>
        <HashLink to="#about" className={"nav-element"} onClick={() => setSelectedHasLink('contacts')} >Contacts</HashLink>
      </nav>
      <SupportContainer/>
    </div>
