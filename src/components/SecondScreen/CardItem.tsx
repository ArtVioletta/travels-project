...
export const CardItem: React.FC<CardItemI> = (props) => {
  return (
    <Card  className="card">
      ...
      />
      <CardContent>
        <Typography gutterBottom variant="h5" component="div" padding={"4px 18px"}>
          {props.nameCountry}
        </Typography>
        <div style={{padding: "4px 18px", color: "red"}}>
          {props.date}
        </div>
      </CardContent>
      <CardActions>
        <Stack direction="row" spacing={1} width={"250px"}
               height={"60px"} margin={"right"} display={"flex"} padding={"4px 18px"}>
